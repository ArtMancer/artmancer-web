...
import { MdSettings, MdPerson, MdMenu, MdLanguage, MdLightMode, MdDarkMode, MdCheck } from "react-icons/md";
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <h4 className="text-[var(--text-primary)] font-medium mb-4 flex items-center gap-2">
                  <MdLightMode className="text-[var(--primary-accent)]" size={18} />
                  {t('settings.theme')}
                </h4>
              ...
              <div>
                <h4 className="text-[var(--text-primary)] font-medium mb-4 flex items-center gap-2">
                  <MdLanguage className="text-[var(--primary-accent)]" size={18} />
                  {t('settings.language')}
                </h4>
                <div className="grid grid-cols-2 gap-3">
                  <button
